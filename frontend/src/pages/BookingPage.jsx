...
//   if (!payType || !paymentMethod) return setMessage("Select payment type and payment method");
...
//       },
//       body: JSON.stringify({ ...form, paymentMethod, payType }),
//     });
...
//           {form.price > 0 && <p className="font-bold mb-2">Price: ₹{form.price}</p>}
...
//             <p>Loading slots...</p>
//           ) : slots.length === 0 ? (
//             <p className="text-red-600">No slots available for selected hall/date/duration</p>
//           ) : (
